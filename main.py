...
os.system(f"touch /home/{current_user}/raspi_video_loop/main_py.log")
logging.basicConfig(filename=f'/home/{current_user}/raspi_video_loop/main_py.log', level=logging.DEBUG)
